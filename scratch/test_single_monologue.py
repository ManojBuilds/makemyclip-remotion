...
t = {
    ...
    "local_path": "downloads/yt_podcast.mp4",
    "r2_key": "test_yt_podcast.mp4",
    "expected_layout": "reframe",
    "start_time": 0.0,
    "end_time": 10.0,
    "filename": "result_podcast_reframe.mp4",
}

print(f"\n🚀 Processing: {t['name']}")
print(f"Uploading {t['local_path']} to Cloudflare R2...")
public_url = "https://pub-dab84dec13074258806f788a00943c46.r2.dev/test_yt_podcast.mp4"
